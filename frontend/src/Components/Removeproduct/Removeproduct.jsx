...
const RemoveProduct = () => {
  ...
  const fetchInfo = async () => {
    try {
      const response = await fetch('https://petadoption-dinr.onrender.com/allproducts');
      if (!response.ok) {
  ...
  const removeProduct = async (id) => {
    try {
      const response = await fetch('https://petadoption-dinr.onrender.com/removeproduct', {
        method: 'POST',
        headers: {
