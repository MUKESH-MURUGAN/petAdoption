...
const AddProduct = () => {
  ...
  const Add_Product = async () => {
    ...
    try {
      const uploadResponse = await fetch('https://petadoption-sgtp.onrender.com/upload', {
        method: 'POST',
        body: formData,
      });
      ...
      if (responseData.success) {
        ...
        const productResponse = await fetch('https://petadoption-sgtp.onrender.com/addproduct', {
          method: 'POST',
          headers: {
